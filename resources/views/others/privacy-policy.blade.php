<p>At {{ config('app.name') }}, accessible from {{ route('index') }}, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by {{ config('app.name') }} and how we use it.</p>
...
<h2 class="fs-4">Consent</h2>

<p>By using our website, you hereby consent to our Privacy Policy and agree to its terms.</p>

<h2 class="fs-4">Information we collect</h2>
...
<h2 class="fs-4">How we use your information</h2>
...
<h2 class="fs-4">Cookies and Web Beacons</h2>
...
<h2 class="fs-4">Google DoubleClick DART Cookie</h2>

<p>Google is one of a third-party vendor on our site. It also uses cookies, known as DART cookies, to serve ads to our site visitors based upon their visit to {{ route('index') }} and other sites on the internet. However, visitors may choose to decline the use of DART cookies by visiting the Google ad and content network Privacy Policy at the following URL – <a href="https://policies.google.com/technologies/ads">https://policies.google.com/technologies/ads</a>.</p>

<h2 class="fs-4">Our Advertising Partners</h2>
...
<h2 class="fs-4">Advertising Partners Privacy Policies</h2>
...
<h2 class="fs-4">Third Party Privacy Policies</h2>
...
<h2 class="fs-4">CCPA Privacy Rights (Do Not Sell My Personal Information)</h2>
...
<h2 class="fs-4">GDPR Data Protection Rights</h2>
...
<h2 class="fs-4">Children's Information</h2>
